...
exports = module.exports = function(options) {
  ...
  // Default options
  options = options || {};
  options.waitFor = options.waitFor || 4000;
  ...
  function getAjaxUrl(req) {
    ...
    if (fragment.length === 0) {
      ...
      url += path + decodeURIComponent(fragment); // formerlly concatenated with #!
    }
    ...
    Browser.visit(url, {waitFor: options.waitFor},
      function(err, browser, status) {
        ...
        links.forEach(function(link) {
          ...
          link.setAttribute('href', url + '?_escaped_fragment_=' + href);
